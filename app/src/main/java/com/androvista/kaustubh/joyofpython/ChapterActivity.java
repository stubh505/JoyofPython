...
public class ChapterActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView lv = findViewById(R.id.chapter_list_view);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(ChapterActivity.this, YoutubeVideoActivity.class);
    ...
    private void loadArrayLists() {
        File f1 = new File(getFilesDir()+"/"+type+"/Chapter Wise/"+chapter, "AllVideos.dat");
        File f2 = new File(getFilesDir()+"/"+type+"/Chapter Wise/"+chapter, "AllVideoTitles.dat");
        try {
